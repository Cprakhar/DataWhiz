...
export const RegisterForm = () => {
  const { register, handleSubmit: rhfHandleSubmit, formState: { errors } } = useForm<RegisterFormData>()
  const { loading, handleSubmit, loginWithOAuth } = useRegister()
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>Get started with DataWhiz to manage your databases</CardDescription>
        </CardHeader>

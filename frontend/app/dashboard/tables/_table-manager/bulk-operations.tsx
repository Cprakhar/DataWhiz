...
import { Upload, Download, Trash2, AlertTriangle, PencilLine } from "lucide-react"
    ...
    <div className="flex items-center gap-2">
      {selectedRecords.length > 0 && (
        <>
          ...
          <Button variant="outline" size="sm" onClick={handleExport} title="Download">
            <Download className="h-4 w-4"/>
          </Button>

          <Dialog open={showBulkUpdate} onOpenChange={setShowBulkUpdate}>
            <DialogTrigger asChild>
              <Button variant="outline" size="sm" title="Update">
      ...
      <Dialog open={showImport} onOpenChange={setShowImport}>
        <DialogTrigger asChild>
          <Button variant="outline" size="sm" title="Import">

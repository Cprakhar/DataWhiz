...
import { ConnectionForm } from "../_connection-form/ConnectionForm";


export const ConnectionManager = () => {
  const { loading, connections, handleDeleteConnection } = useConnectionManager();
  ...
  return (
    <div className="w-full max-w-none">
      <div className="space-y-6">
        ...
        <ConnectionForm show={showConnectionForm} setShow={setShowConnectionForm} />
      </div>
    </div>
  );
}
